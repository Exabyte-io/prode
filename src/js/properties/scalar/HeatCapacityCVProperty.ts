...
import {
    ...
    heatCapacityCVPropertySchemaMixin,
} from "../../generated/HeatCapacityCVPropertySchemaMixin";
...
export default class HeatCapacityCVProperty extends (Property as Base) implements Schema {
...
heatCapacityCVPropertySchemaMixin(HeatCapacityCVProperty.prototype);
